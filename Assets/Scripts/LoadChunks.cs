...
public class LoadChunks : MonoBehaviour
{
    ...
    void LoadAndRenderChunks()
    {
        ...
        //Checks if chunks need to be updated
    ...
    //Timer takses 10 frames to delete code, checks the distance to the game object
    //and adds to a list to delete
    void DeleteChunks()
    {
        if (timer == 10)
        {
    ...
    //Queue of chunk positions sorted by closeness to the centre(0,0,0)
